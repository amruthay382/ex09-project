...
The histogram shows that most students rated their interest in livestreamed lectures highly, with many responses clustered around 6 and 7. The relationship between lecture effectiveness and livestream interest shows a positive correlation which indicates/supports the notion that students who find lectures effective are also more interested in having livestream options. The boxplot further confirms that since the median values for livestream interest and pre-lecture videos are high.
